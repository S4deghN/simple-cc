...
assert 9 'int main() { int a; for (a = 0; a < 9; a = a + 1) {} return a; }'

assert 10 'int main() { int a = 0; while((a = a+1) < 10) {} return a; }'
assert 10 'int main() { int a = 0; while(a < 10) { a = a + 1; } return a; }'
assert 0  'int main() { while(0) { return 10; } return 0; }'
assert 10 'int main() { while(1) { return 10; } return 0; }'

assert 9 'int main() {int a = 9; int *b = &a; int **c = &b; return **c;}'
...
assert 4 'int main() { int x=3; int y=4; int *z=&*(&x + 1); return *z;}'
assert 5 'int main() { int x=3; int *y=&x; *y=5; return x; }'
