...
assert 9 '{ int a; for (a = 0; a < 9; a = a + 1) {} return a; }'

assert 10 '{ int a = 0; while((a = a+1) < 10) {} return a; }'
assert 10 '{ int a = 0; while(a < 10) { a = a + 1; } return a; }'
assert 0  '{ while(0) { return 10; } return 0; }'
assert 10 '{ while(1) { return 10; } return 0; }'

assert 9 '{int a = 9; int *b = &a; int **c = &b; return **c;}'
...
assert 4 '{ int x=3; int y=4; int *z=&*(&x + 1); return *z;}'
assert 5 '{ int x=3; int *y=&x; *y=5; return x; }'
